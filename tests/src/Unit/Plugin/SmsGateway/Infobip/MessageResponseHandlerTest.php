    ...
    return [
      [
        ...
        [
          ...
          'report' => [
            '41793026727' => new SmsDeliveryReport(['recipient' => '41793026727', 'message_id' => 'MESSAGE-ID-123-xyz'] + $report1),
            '41793026731' => new SmsDeliveryReport(['recipient' => '41793026731', 'message_id' => '9304a5a3ab19-1ca1-be74-76ad87651ed25f35'] + $report1),
            '41793026785' => new SmsDeliveryReport(['recipient' => '41793026785', 'message_id' => '5f35f87a2f19-a141-43a4-91cd81b85f8c689'] + $report1)],
        ],
      ],
    ];
  }
